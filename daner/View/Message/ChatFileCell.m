...
-(UIImageView *)BGImage{
    if (!_BGImage) {
        ...
        _BGImage.image = [UIImage imageNamed:@"D_chat"];
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.BGView.frame = CGRectMake(10, 20, 248, 93);
        self.reviewerBtn.frame = CGRectMake(4, 4, 40, 40);
        self.BGImage.frame = CGRectMake(55, 7, 50, 50);
        ...
        self.dateLabel.frame = CGRectMake(self.BGView.ctRight-40-22, self.BGImage.ctBottom+10, 40, 10);
         self.moneyLabel.frame = CGRectMake(self.BGImage.ctRight+10, self.titleLabel.ctBottom+5 , 118 , 13);
        self.detailLabel.frame = CGRectMake(self.BGImage.ctRight+10, self.moneyLabel.ctBottom+3 , 118 , 9);
