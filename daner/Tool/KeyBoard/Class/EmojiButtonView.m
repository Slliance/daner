...
- (void)layoutUI
{
    ...
    [self.emojiButotn setImage:[UIImage imageNamed:@"expression_chat"] forState:UIControlStateNormal];
    [self.emojiButotn setImage:[UIImage imageNamed:@"expression_chat"] forState:UIControlStateSelected];
    ...
    [self.emojiImageButotn setImage:[UIImage imageNamed:@"expression_chat"] forState:UIControlStateNormal];
    [self.emojiImageButotn setImage:[UIImage imageNamed:@"expression_chat"] forState:UIControlStateSelected];
    ...
    self.collectionView.backgroundColor = DSColorFromHex(0xFAFAFA);
