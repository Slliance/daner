...
static NSString *kResultCellIdentifier = @"MyFriendsCell";
...
- (instancetype)initWithStyle:(UITableViewStyle)style {
    ...
    if (self) {
        [self.tableView registerClass:[MyFriendsCell class] forCellReuseIdentifier:kResultCellIdentifier];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MyFriendsCell *cell = [tableView dequeueReusableCellWithIdentifier:kResultCellIdentifier];
    ...
    cell.reviewerName.attributedText = attributedString;
