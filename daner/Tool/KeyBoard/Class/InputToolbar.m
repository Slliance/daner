...
- (void)layoutUI
{
    ...
    if (!self.emojiButton) {
        ...
        [self.emojiButton setImage:[UIImage imageNamed:@"expression_chat"] forState:UIControlStateNormal];
    ...
    if (!self.moreButton) {
        ...
        [self.moreButton setImage:[UIImage imageNamed:@"add_chat"] forState:UIControlStateNormal];
        [self.moreButton setImage:[UIImage imageNamed:@"add_chat"] forState:UIControlStateHighlighted];
