...
@implementation FoundListRecordCell
...
-(UILabel *)locLabel{
    if (!_locLabel) {
        ...
        _locLabel.text = @"上海·人民广场";
        _locLabel.font = [UIFont boldSystemFontOfSize:12];
        _locLabel.textAlignment = NSTextAlignmentLeft;
        _locLabel.textColor = DSColorFromHex(0x969595);
    }
    return _locLabel;
}
-(UILabel *)mentionLabel{
    if (!_mentionLabel) {
        _mentionLabel = [[UILabel alloc]init];
        _mentionLabel.text = @"提到了:风息神泪、花花世界、阳光旅人";
        _mentionLabel.font = [UIFont systemFontOfSize:12];
        _mentionLabel.textAlignment = NSTextAlignmentLeft;
        _mentionLabel.textColor = DSColorFromHex(0x658AB3);
...
-(void)setContentLayout{
    ...
    [self.BGView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.headBtn.mas_bottom).offset(19);
    ...
    [self.BGImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.BGView).offset(56);
        make.right.equalTo(self.BGView).offset(-47);
        make.centerY.equalTo(self.BGView);
    ...
    [self.mentionLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self).offset(13);
        make.right.equalTo(self).offset(-20);
        make.top.equalTo(self.locLabel.mas_bottom).offset(10);
    }];
    [self.likeBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self).offset(13);
        make.top.equalTo(self.mentionLabel.mas_bottom).offset(20);
