...
{
    UIButton *leftBtn;
    self.scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, SCREENWIDTH, self.layout.sliderHeight)];
    ...
    for (NSInteger i = 0;i <self.layout.titles.count ; i ++) {
        ...
        if (i == 0) {
            ...
            btn.titleLabel.font = self.layout.titleSelectFont;
            _oldButton = btn;
...
- (void)btnClick:(UIButton *)button
{
    ...
    _oldButton.titleLabel.font = self.layout.titleFont;
    _oldButton = button;
