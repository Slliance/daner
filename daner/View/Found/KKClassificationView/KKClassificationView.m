...
- (void)setSubView
{
    ...
    _sliderView = [[KKSliderButtonView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.layout.sliderHeight) layout:self.layout];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    subVC.view.frame = CGRectMake(0, 0, self.frame.size.width, self.frame.size.height - self.layout.sliderHeight);
...
- (UICollectionView *)collection
{
    if (!_collection) {
        ...
        layout.itemSize = CGSizeMake(SCREENWIDTH, self.frame.size.height - self.layout.sliderHeight);
        layout.minimumLineSpacing = 0;
        layout.minimumInteritemSpacing = 0;
        layout.sectionInset = UIEdgeInsetsZero;
        layout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
        
        _collection = [[UICollectionView alloc] initWithFrame:CGRectMake(0, self.layout.sliderHeight, self.frame.size.width, self.frame.size.height - self.layout.sliderHeight) collectionViewLayout:layout];
